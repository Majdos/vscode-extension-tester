...
import { FileType, IActivityBar, IBottomBarPanel, IEditorView, IInputBox, INotification, INotificationsCenter, IOpenDialog, ISettingsEditor, ISideBarView, IStatusBar, ITitleBar, IWorkbench } from "extension-tester-page-objects";
